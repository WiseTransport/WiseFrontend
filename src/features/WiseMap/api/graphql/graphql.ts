...
export type RentalVehicle = Node &
  PlaceInterface & {
...
export type VehicleParking = Node &
  PlaceInterface & {
...
export type VehicleRentalStation = Node &
  PlaceInterface & {
...
export type GetRouteDetailsQuery = {
  __typename?: "QueryType"
  route?: {
    __typename?: "Route"
    ...
    patterns?: Array<{
      __typename?: "Pattern"
      patternGeometry?: { __typename?: "Geometry"; points?: any | null } | null
    } | null> | null
  } | null
}
...
export type GetStopsByBboxQuery = {
  __typename?: "QueryType"
  stopsByBbox?: Array<{
    __typename?: "Stop"
    gtfsId: string
...
export const GetRouteDetailsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getRouteDetails" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "gtfsId" } },
          type: {
            kind: "NonNullType",
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "gtfsId" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
                ...
                { kind: "Field", name: { kind: "Name", value: "color" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "patternGeometry" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
...
} as unknown as DocumentNode<GetRouteDetailsQuery, GetRouteDetailsQueryVariables>
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getStopsByBbox" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "maxLat" } },
          type: {
            kind: "NonNullType",
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "maxLon" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Float" } },
          },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "minLat" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Float" } },
          },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "minLon" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Float" } },
          },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "stopsByBbox" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "maxLat" },
                value: { kind: "Variable", name: { kind: "Name", value: "maxLat" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "maxLon" },
                value: { kind: "Variable", name: { kind: "Name", value: "maxLon" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "minLat" },
                value: { kind: "Variable", name: { kind: "Name", value: "minLat" } },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "minLon" },
                value: { kind: "Variable", name: { kind: "Name", value: "minLon" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
...
} as unknown as DocumentNode<GetStopsByBboxQuery, GetStopsByBboxQueryVariables>
